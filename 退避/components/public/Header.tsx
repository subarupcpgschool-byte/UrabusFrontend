        ...
        {isDesktop ? (
          <>
            ...
            <View style={styles.actions}>
              <Pressable
                onPress={() => move("/login" as Href)}
                style={styles.loginButton}
              >
                <Text style={styles.loginText}>ログイン</Text>
              </Pressable>
              <Pressable
                onPress={() => move("/signup/user" as Href)}
      ...
      {!isDesktop && menuOpen && (
        <View style={styles.mobileMenu}>
          ...
          <View style={styles.mobileActions}>
            <Pressable
              onPress={() => move("/login" as Href)}
              style={[styles.secondaryButton, styles.mobileAction]}
            >
              <Text style={styles.secondaryText}>ログイン</Text>
            </Pressable>
            <Pressable
              onPress={() => move("/signup/user" as Href)}
              style={[styles.primaryButton, styles.mobileAction]}
            >
              <Text style={styles.primaryText}>無料で始める</Text>
            </Pressable>
          </View>
