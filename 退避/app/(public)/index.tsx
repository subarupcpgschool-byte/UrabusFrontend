...
export default function TopScreen() {
  ...
  return (
    <View style={[styles.content, { paddingHorizontal: pagePadding }]}>
      ...
      <View
        style={[styles.featureStrip, !isTablet && styles.featureStripMobile]}
      >
  ...
  return (
    <View style={[styles.hero, !isDesktop && styles.heroMobile]}>
      <View style={[styles.heroCopy, !isDesktop && styles.heroCopyMobile]}>
        ...
        <View
          style={[styles.searchPanel, !isDesktop && styles.searchPanelMobile]}
        >
          <SearchInput
            icon="search-outline"
            value={keyword}
        ...
        <View
          style={[styles.heroNumbers, !isDesktop && styles.heroNumbersMobile]}
        >
  ...
  return (
    <View style={[styles.jobCard, { width }]}>
      ...
      <View style={styles.jobActions}>
        ...
        <PrimaryButton
          label="応募する"
          onPress={() => router.push(`/jobs/${job.id}/apply` as Href)}
        />
      </View>
    </View>
  );
